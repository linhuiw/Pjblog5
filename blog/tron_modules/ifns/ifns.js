(function(mod) {
	...
	fns.extend = function(source, target){
	...
	fns.jsonp = function( str , callback ){
		var c = {};
	...
	fns.removeHTML = function(html){
		return html.replace(/\<[^>]+\>/g, '');
	}
	
	fns.unHTMLStr = function( str ){
		if ( !str ){
			return "";
		}
		try{
	...
	fns.unTextareaStr = function( str ){
		if ( !str ){
			return "";
		}
		try{
