...
exports.category = { icon: 'fa-pie-chart', name: '分类', des: '大范围无刷新操作，摒弃以往的难操作分类方式，让用户体验更佳！' };
...
exports.user = { icon: 'fa-user', name: '用户', des: '用户管理中心。用户全部来自PJBlog官方云平台。' };
exports.level = { icon: 'fa-tachometer', name: '权限', des: '系统用户组和系统用户权限让开发者更加灵活区分用户所属等级。' };
exports.theme = { icon: 'fa-html5', name: '主题', des: '本地主题。管理你的主题。主题制作请参考官方的API文档。' };
